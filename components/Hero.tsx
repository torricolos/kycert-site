...
export default function Hero() {
  ...
  return (
    <Section pad="80px 32px 96px">
      <div style={{ maxWidth: 1000 }}>
        ...
        <h1 style={{
          ...
          <span style={{
            ...
            fontWeight: 400, color: 'var(--brand-accent-signal)',
          }}>
      ...
      <div role="list" aria-label="Principais números da plataforma" style={{
        marginTop: 96,
        ...
        {stats.map((s, i) => (
          <div key={i} role="listitem" style={{
            ...
            <div style={{
              ...
              fontSize: s.mono ? 'clamp(18px, 2vw, 22px)' : 'clamp(36px, 4.5vw, 56px)',
            ...
            <div style={{
              marginTop: 16, fontSize: 'var(--text-sm)',
              color: 'var(--text-tertiary)', lineHeight: 1.5, maxWidth: 220,
            }}>
              {s.l}
            </div>
          </div>
