...
export const metadata: Metadata = {
  ...
  description:
    'Como a kycert protege os dados dos seus clientes: LGPD desde o desenho, criptografia, controle de acesso e registros imutáveis.',
