...
<div class="faq">
  ...
  <details><summary>Vocês têm certificação de segurança (ISO 27001, SOC 2)?<span class="plus">+</span></summary><div class="ans">A plataforma adota criptografia, residência de dados no Brasil, controle de acesso com autoria e registros imutáveis. As certificações formais (ISO 27001, SOC 2) estão em processo de certificação. <a class="gl-link" href="/seguranca">Ver práticas de segurança →</a></div></details>
</div>
<div class="faq-cta">
