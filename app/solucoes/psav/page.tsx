...
<div class="wrap hero">
  <div class="hero-grid">
    <div>
      ...
      <p class="lead reveal reveal-d2">Com a entrada das prestadoras de ativos virtuais sob autorização e supervisão do Banco Central, o cadastro de cliente deixou de ser opcional e passou a ter deveres de PLD/FT. A kycert registra cadastro, risco e decisão de cada cliente numa trilha auditável.</p>
...
<section>
  <div class="wrap sec-head">
    ...
    <div class="norms">
      ...
      <div class="norm reveal reveal-d3"><div class="nlaw">Resolução BCB nº 521/2025</div><p>Complementa o regime das PSAVs e fixa o cronograma de adequação: vigência em 02/02/2026 e pedido de autorização até 20/10/2026.</p><div class="entra"><b>Onde a kycert entra</b>Deixa o onboarding e a trilha prontos para apresentar no pedido de autorização, dentro do prazo.</div></div>
    </div>
    <div class="norms-ctx">
